...
Display( )
{
	...
	Pattern.SetUniformVariable("uLightPos", 2.0f, 3.0f, 4.0f);
	Pattern.SetUniformVariable("uResolution", (float)vx, (float)vy);
...
InitGraphics( )
{
	...
	Pattern.Use( );
	Pattern.SetUniformVariable( (char *)"uKa", 0.15f );
	Pattern.SetUniformVariable( (char *)"uKd", 0.55f );
	Pattern.SetUniformVariable( (char *)"uKs", 0.40f );
	Pattern.SetUniformVariable((char*)"uShininess", 64.f);
	Pattern.SetUniformVariable( (char *)"uColor", 1.f, 0.35f, 0.05f, 1.f );
	Pattern.SetUniformVariable( (char *)"uSpecularColor", 1.f, 0.95f, 0.85f, 1.f );
	Pattern.UnUse( );
}
